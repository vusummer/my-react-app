...
const DetailPage = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            ...
            try {
                const productData = await getProduct('Product', params.id);
                console.log('Product data:', productData);
                setProduct(productData);
            } catch (err) {
                setError(`Error fetching product with id ${params.id}`);
            } finally {
                setLoading(false);
            }
        };
                        ...
                        <div className="col-lg-8 col-xl-9">
                            <div className="row g-4">
                                ...
                                <form action="#">
                                    ...
                                    <div className="row g-4 bg-light border rounded">
                                        <div className="col-lg-6">
                                        ...
                                        <textarea name="" id="" className="form-control border-0 " cols={28} rows={6} placeholder="Your Review *" spellCheck={false}></textarea>
                                        <div className="col-lg-12">
